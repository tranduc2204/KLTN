 ...
 * @author TeeDee
 */
public class ProgressCircleUI extends FlatProgressBarUI {//BasicProgressBarUI
    ...
    private void paintString(Graphics g) {
        ...
        g.setColor(new Color(212, 212, 212));//212
//        g.setColor(Color.BLUE);
        paintString(g, b.left, b.top, barRectWidth, barRectHeight, 0, b);
    }
    
    
    protected Color getForegroundDeterminate() {
        return Color.BLUE;  // Đặt màu tiến trình cho ProgressBar
    }
